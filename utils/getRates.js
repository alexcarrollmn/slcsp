module.exports = (plansData, item, zipsData) => {
    ...
    //e.g. only returns relevant plans for NY, Silver, 3 and then
    //returns only the rate for the second lowest cost option.
    //Example Return: { zipcode: '20047', rate: '322.20' }
